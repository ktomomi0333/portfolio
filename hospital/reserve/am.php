...
<head>
  ...
  if(((date('H:i:s')<='00:00:00') || (date('H:i:s')>='23:50:00')) || (date(‘w’) == 6 || date(‘w’) == 7)): ?>
  <p>現在予約時間外です。</p>
  <p>土曜日、日曜日は休診日となります。</p>
  <p>ネット予約ができる時間帯は午前は8:00から11:30です</p>
  <p>午前11:30以降の予約は午後で予約してください。</p>
  <?php elseif($error['over'] == 'over'): ?>
    <p>午前中の診療は定員超えです。午後の診療にご予約してください。</p>
  <?php else: ?>
...
<body>
  ...
  <?php else: ?>
    <p class="text">現在予約すると午前中の<span class="cnt"><?= $reserve_num; ?>番目</span>に予約できます。<br>本日予約しますか？</p>
